...
import { SubprocessorRegister } from '@/components/legal/SubprocessorRegister';
      ...
      <div className="mkt-page-head mkt-page-head--dark">
        <div className="mkt-inner">
          ...
          <p>
            ...
            ({LEGAL_COMPANY.name}) przy korzystaniu z platformy Scopeo. Na dole strony znajduje się
            <a href="#wykaz-subprocesorow" className="mkt-link">
              {' '}
              przewidywalny wykaz subprocesorów
            </a>
            .
          </p>
